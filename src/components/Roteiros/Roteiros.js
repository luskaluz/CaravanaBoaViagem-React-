                                         ...
                                         return (
                                             <div key={caravana.id} className={styles.roteiroCard}>
                                                 ...
                                                 <div className={styles.cardContent}>
                                                     ...
                                                     <p className={styles.vagas}>Vagas disponiveis: {disponibilidade.capacidadeTotalExibida === 0 ? 'A definir' : (disponibilidade.vagasCliente === 0 ? 'Esgotado' : disponibilidade.vagasCliente)}</p>
