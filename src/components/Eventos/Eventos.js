                    ...
                    return (
                        <div key={caravana.id} className={styles.eventoCard}>
                            ...
                            <div className={styles.eventoCardConteudo}>
                                ...
                                <p><strong>Vagas Disponíveis:</strong> {disponibilidade.capacidadeTotalExibida === 0 ? 'A definir' : (disponibilidade.vagasCliente === 0 ? 'Esgotado' : disponibilidade.vagasCliente)}</p>
